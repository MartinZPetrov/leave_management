    ...
    public class LeaveRequestController : Controller
    {
        ...
        public ActionResult ApproveRequest(int id)
        {
            try
            {
                ...
                var allocation = _leaveAllocRepo.GetLeaveAllocationsByEmployeeAndType(leaveRequest.RequestingEmployeeId, leaveRequest.Id);
        ...
        public ActionResult MyLeave()
        {
            ...
            var employeeLeaveRequets = _leaveRequestRepo.GetLeaveRequestsByEmployee(employeeId);
